...
def get_events(
    ...
    **kwargs,
    ...
    return [EventIngestionModel(
            body=Body(name="test test"),
            sessions=[
                Session(
                    video_uri="https://sg001-harmony01.sliq.net/archives/00309/2021/01/05/House%20Appropriations_2021-01-05-09.02.00_40001_1115.mp4",
                    # TODO: Scrape correct datetime for session
                    session_datetime=datetime.now(),
                    session_index=0,
                    transcription_start_time="05:55:55",
                    transcription_end_time="06:06:23"
                ),
            ],
        )]
